...
@section('content')
    ...
    <div id="page-wrapper">
        ...
        <div class="row">
            <div class="col-sm-12">
                <h1 class="page-header"><i class="fa-solid fa-building-columns"></i> 中分類管理</h1>
            </div>
        </div>
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-heading">
                        <div class="row">
                            ...
                            <div class="col-sm-2">
                                <a class="btn btn-block btn-warning btn-sm" id="btn-new" href="{{route('category.create')}}"><i class="fa-solid fa-plus"></i> 新增</a>
                            </div>
                            @endif
                        </div>
                    </div>
                            ...
                            @foreach ($data as $k => $v)
                                <tr>
                                    <td>
                                        ...
                                        <a class="btn btn-block btn-info btn-sm" href="{{route('category.edit' , $v['id'])}}">
