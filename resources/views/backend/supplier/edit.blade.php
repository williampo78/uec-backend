                        ...
                        <div class="panel-body">
                            <form id="edit-form" method="post" action="{{ route('supplier.update', $supplier->id) }}">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <v-select v-model="form.supplierTypeId" :reduce="option => option.code"
                                                ...
                                                <template #search="{attributes, events}">
                                                    <input class="vs__search" :required="!form.supplierTypeId"
                                ...
                                <div class="row">
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            <label class="control-label" for="date_from">合約起日 <span
                                                    style="color: red;">*</span></label>
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            <label class="control-label" for="date_to">合約訖日 <span
                                                    style="color: red;">*</span></label>
