            ...
            <div class="modal-body">
                <div class="panel panel-default">
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-4">
                                        <div class="input-group" id="gift-modal-start-created-at-flatpickr">
                                            <input type="text" class="form-control" id="gift-modal-start-created-at" autocomplete="off" data-input />
                                    ...
                                    <div class="col-sm-4">
                                        <div class="input-group" id="gift-modal-end-created-at-flatpickr">
                                            <input type="text" class="form-control" id="gift-modal-end-created-at" autocomplete="off" data-input />
                                            <span class="input-group-btn" data-toggle>
                                                <button class="btn btn-default" type="button">
                                                    <i class="fa-solid fa-calendar-days"></i>
                                                </button>
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-4">
                                        <div class="input-group" id="gift-modal-start-launched-at-start-flatpickr">
                                            <input type="text" class="form-control" id="gift-modal-start-launched-at-start" autocomplete="off" data-input />
                                            <span class="input-group-btn" data-toggle>
                                                <button class="btn btn-default" type="button">
                                                    <i class="fa-solid fa-calendar-days"></i>
                                                </button>
                                    ...
                                    <div class="col-sm-4">
                                        <div class="input-group" id="gift-modal-start-launched-at-end-flatpickr">
                                            <input type="text" class="form-control" id="gift-modal-start-launched-at-end" autocomplete="off" data-input />
                                            <span class="input-group-btn" data-toggle>
                                                <button class="btn btn-default" type="button">
                                                    <i class="fa-solid fa-calendar-days"></i>
                                                </button>
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6 text-right">
                                        <button type="button" class="btn btn-warning" id="gift-modal-btn-search"><i class="fa-solid fa-magnifying-glass"></i> 查詢</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-sm-12">
                                <button type="button" class="btn btn-success" id="gift-modal-btn-save"><i class="fa-solid fa-floppy-disk"></i> 儲存</button>
                                <button type="button" class="btn btn-success" id="gift-modal-btn-save-and-close" data-dismiss="modal"><i class="fa-solid fa-floppy-disk"></i> 儲存並關閉</button>
                            ...
                            <div class="col-sm-12">
                                <button type="button" class="btn btn-primary" id="gift-modal-btn-check-all"><i class="fa-solid fa-check"></i> 全勾選</button>
                                <button type="button" class="btn btn-primary" id="gift-modal-btn-cancel-all"><i class="fa-solid fa-xmark"></i> 全取消</button>
                            </div>
                        </div>
                        <br/>
