...
@section('content')
    <div id="app" v-cloak>
        ...
        <div id="page-wrapper">
            ...
            <div class="row">
                <div class="col-sm-12">
                    <h1 class="page-header"><i class="fa-solid fa-plus"></i> 新增寄售商品入庫申請</h1>
                </div>
            </div>
            <!-- /.row -->
            <div class="row">
                <div class="col-sm-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <form id="create-form" method="post" action="{{ route('buyout_stock_in_requests.store') }}">
                                @csrf
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <a href="{{ route('buyout_stock_in_requests') }}" class="btn btn-danger" id="btn-cancel"><i
