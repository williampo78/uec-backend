    ...
    <div class="modal-dialog">
        <div class="modal-content modal-primary panel-primary">
            <div class="modal-header panel-heading">
                ...
                <h4 class="modal-title" id="myModalLabel"><i class="fa-solid fa-gear"></i> 分類階層內容管理</h4>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="row form-group">
                                ...
                                <div class="col-sm-4">
                                    <div v-if="category_hierarchy_content.active == '1'">開啟</div>
                                    <div v-else>關閉</div>
                                </div>
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-sm-4">
                                    <div v-if="category_hierarchy_content.content_type === 'P'">
                                        指定產品
                                    </div>
                                    <div v-else-if="category_hierarchy_content.content_type === 'M'">指定賣場</div>
                                    <div v-else>尚未指定</div>
                                </div>
                            </div>
                        </div>
