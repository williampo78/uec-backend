...
@section('content')
    <div id="page-wrapper">
        ...
        <!-- /.row -->
        <form role="form" id="new-form" method="post" action="{{ route('webcontents.update' , $data['webcontent']->id) }}"
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-sm-12">
                                        ...
                                        <div class="col-sm-4">
                                            <div class="form-group" id="div_content_name">
                                                ...
                                                <input class="form-control validate[required]" type="text" name="content_name"
                                                       id="content_name" value="{{$data['webcontent']['content_name']}}">
                                            </div>
                                        </div>
                                        <div class="col-sm-4">
                                            ...
                                            <div class="form-group" id="div_content_target">
                                                ...
                                                <select name="content_target" id="content_target" class="validate[required]">
                                                    ...
                                                    @foreach($data['target'] as $k=>$v)
                                                        <option value="{{$k}}" {{$data['webcontent']['content_target'] == $k ? 'selected':''}}>{{$v}}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row" id="div_content_url" style="display: {{$data['webcontent']['content_target']=='S'?'':'none;'}};" >
                                        <div class="col-sm-12">
                                    ...
                                    <div class="row" id="div_editor" style="display: {{$data['webcontent']['content_target']=='H'?'':'none;'}};" >
                                        <div class="col-sm-12" >
                                            <div class="form-group">
                                                <label for="content_name">單一圖文</label>
