...
Object(function webpackMissingModule() { var e = new Error("Cannot find module '@uppy/locales/lib/zh_TW'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
Object(function webpackMissingModule() { var e = new Error("Cannot find module '@uppy/form'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
Object(function webpackMissingModule() { var e = new Error("Cannot find module '@uppy/file-input'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
...
(_uppy_core__WEBPACK_IMPORTED_MODULE_1___default().Locale) = Object(function webpackMissingModule() { var e = new Error("Cannot find module '@uppy/locales/lib/zh_TW'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
(_uppy_core__WEBPACK_IMPORTED_MODULE_1___default().Dashboard) = Object(function webpackMissingModule() { var e = new Error("Cannot find module '@uppy/dashboard'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
(_uppy_core__WEBPACK_IMPORTED_MODULE_1___default().Form) = Object(function webpackMissingModule() { var e = new Error("Cannot find module '@uppy/form'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
(_uppy_core__WEBPACK_IMPORTED_MODULE_1___default().FileInput) = Object(function webpackMissingModule() { var e = new Error("Cannot find module '@uppy/file-input'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()); // 初始化資料
