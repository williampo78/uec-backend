...
var validateImageBlock = function validateImageBlock(row_no) {
  ...
  $("#image-block table > tbody [name=\"target_campaign_brief[".concat(row_no, "]\"]")).rules("add", {
    required: {
      depends: function depends(element) {
...
var validateTextBlock = function validateTextBlock(row_no) {
  ...
  $("#text-block table > tbody [name=\"target_campaign_brief[".concat(row_no, "]\"]")).rules("add", {
    required: {
      depends: function depends(element) {
...
window.init = function () {
  ...
  var startLaunchedAtLastSelectedDates;
  ...
  $(document).on("click", '[name^="image_block_image_action"]', function () {
    ...
    switch (image_action) {
      case "X":
        ...
        form_group_element.find('[name^="target_campaign_brief"]').val("");
...
window.addImageBlock = function () {
  ...
  var target_campaign_brief = datas.campaign_brief ? datas.campaign_brief : "";
